...
static ERL_NIF_TERM jq_nif(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[])
{
    ...
    enif_get_string(env, argv[0], program, 256, ERL_NIF_LATIN1);
    enif_get_string(env, argv[1], value, 1024, ERL_NIF_LATIN1);
